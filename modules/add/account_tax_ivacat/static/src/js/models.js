function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.PosModel = Backbone.Model.extend({
        ...
        models: [
        {
            ...
            model:  'account.tax',
            //añadido campo percent_comp
            fields: ['name','amount', 'price_include', 'include_base_amount', 'type', 'child_ids', 'child_depend', 'include_base_amount','percent_comp'],
            domain: null,
            ...
            _(taxes).each(function(tax) {
                if (tax.price_include) {
                    if (tax.type === "percent") {
                        ...
                        res.push(data);
                    //else añadido
                    } else if (tax.type === "code") {
                         tmp = base * (tax.percent_comp/100);
                         data = {amount:tmp, price_include:false, id: tax.id};
                         res.push(data);                
                    }else {
                        throw "This type of tax is not supported by the point of sale purchase: " + tax.type;
                    }
                } else {
                    if (tax.type === "percent") {
    ...
    module.Order = Backbone.Model.extend({
        ...
        export_as_JSON: function() {
            ...
            return {
                ...
                porcentaje_iva_aplicado:this.porcentaje_iva_aplicado,
            };
        },
