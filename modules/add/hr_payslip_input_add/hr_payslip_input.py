...
class PayslipInput(osv.osv):
    ...
    _columns = {
        'expense_type_id' : fields.many2one('hr.expense.type', 'Tipo de Egreso', required=False),
        'period_id' : fields.many2one('hr.contract.period', 'Periodo', help="Mes al que pertenece", ondelete='restrict', required=False),
        'employee_id' : fields.many2one('hr.employee', "Empleado", ondelete='cascade', required=True),
        'tipo':fields.char('Tipo', size=4),
    }
