...
class wizard_account_retention(osv.osv_memory):
    """
    Generate Entries by Statement from Invoices
    """
    _name = "wizard.account.retention"
    ...
    def _get_move_line(self, cr, uid, ids, context=None):
        ...
        if context is None:
            context = {}
        retention_id = context.get('retention_id', False)
        if not retention_id:
        ...
        statement = statement_obj.browse(cr, uid, retention_id, context=context)
