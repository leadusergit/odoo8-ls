...
class account_invoice_ind(report_sxw.rml_parse):
    _name = 'account.invoice.ind'
    _description = 'Factura de Ventas'
    
    def __init__(self, cr, uid, name, context):
        super(account_invoice_ind, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.account.invoice.ind',
                      'account.invoice',
                      'addons/account_invoice_retention/report/invoice_ind.rml',
                      parser=account_invoice_ind,
                      header=False)
