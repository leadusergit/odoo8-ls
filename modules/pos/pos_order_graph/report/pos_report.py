...
class PosInvoiceReport(osv.AbstractModel):
    ...
    def render_html(self, cr, uid, ids, data=None, context=None):
        ...
        report = report_obj._get_report_from_name(cr, uid, 'pos_order_graph.reporte_pos_invoice')
        print"report=%s"%report
        selected_orders = posorder_obj.browse(cr, uid, ids, context=context)
        print"selected_orders=%s"%selected_orders
        ids_to_print = []
        invoiced_posorders_ids = []
        print"ids_to_print%s"%ids_to_print
        ...
        return report_obj.render(cr, uid, ids, 'pos_order_graph.reporte_pos_invoice', docargs, context=context)
